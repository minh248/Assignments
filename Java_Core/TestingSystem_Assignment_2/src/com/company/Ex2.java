...
public class Ex2 {
    public static void main(String[] args) {
        ...
        System.out.println("|      Email      |      Username      |           Full name           |      Department      |     Position     |   Create date   |");
        System.out.println("------------------------------------------------------------------------------------------------------------------------------------");
        for (Account account : accounts) {
            System.out.printf("|%17s|%20s|%31s|%22s|%18s|%17s| \n",account.email,account.username,account.fullname,account.fullname,account.department.name,account.position.name,account.createDate);
        }
    }
}
