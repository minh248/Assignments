...
public class Ex3 {
    public static void main(String[] args) {
        ...
        // Question 4
        System.out.println(DateTimeFormatter.ofPattern("yyyy-MM").format(LocalDateTime.now()));

        // Question 5
        System.out.println(DateTimeFormatter.ofPattern("MM-dd").format(LocalDateTime.now()));
    }
}
